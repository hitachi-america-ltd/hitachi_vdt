...
Sidebar.Geometry.TeapotBufferGeometry = function ( signals, object ) {
	...
	sizeRow.add( new UI.Text( editor.languageData.Size ).setWidth( '90px' ) );
	sizeRow.add( size );
	...
	segmentsRow.add( new UI.Text( editor.languageData.Segments ).setWidth( '90px' ) );
	...
	bottomRow.add( new UI.Text( editor.languageData.Bottom ).setWidth( '90px' ) );
	...
	lidRow.add( new UI.Text( editor.languageData.Lid ).setWidth( '90px' ) );
	lidRow.add( lid );
	...
	bodyRow.add( new UI.Text( editor.languageData.Body ).setWidth( '90px' ) );
	bodyRow.add( body );
	...
	fitLidRow.add( new UI.Text( editor.languageData.FittedLid ).setWidth( '90px' ) );
	...
	blinnRow.add( new UI.Text( editor.languageData.Blinn-scaled ).setWidth( '90px' ) );
	blinnRow.add( blinn );
