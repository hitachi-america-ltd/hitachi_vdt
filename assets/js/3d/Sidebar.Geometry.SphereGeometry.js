...
Sidebar.Geometry.SphereGeometry = function ( editor, object ) {
	...
	radiusRow.add( new UI.Text(  editor.languageData.Radius ).setWidth( '90px' ) );
	...
	widthSegmentsRow.add( new UI.Text(  editor.languageData.Widthsegments ).setWidth( '90px' ) );
	...
	heightSegmentsRow.add( new UI.Text(  editor.languageData.Heightsegments ).setWidth( '90px' ) );
	...
	phiStartRow.add( new UI.Text(  editor.languageData.Phistart ).setWidth( '90px' ) );
	...
	phiLengthRow.add( new UI.Text(  editor.languageData.Philength ).setWidth( '90px' ) );
	...
	thetaStartRow.add( new UI.Text(  editor.languageData.Thetastart ).setWidth( '90px' ) );
	...
	thetaLengthRow.add( new UI.Text(  editor.languageData.Thetalength ).setWidth( '90px' ) );
