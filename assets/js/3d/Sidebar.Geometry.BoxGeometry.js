...
Sidebar.Geometry.BoxGeometry = function ( editor, object ) {
	...
	widthRow.add( new UI.Text( editor.languageData.Width ).setWidth( '90px' ) );
	widthRow.add( width );
	...
	depthRow.add( new UI.Text( editor.languageData.Depth ).setWidth( '90px' ) );
	depthRow.add( depth );
	...
	depthSegmentsRow.add( new UI.Text(  editor.languageData.Depthsegments ).setWidth( '90px' ) );
