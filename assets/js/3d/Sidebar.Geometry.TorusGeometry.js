...
Sidebar.Geometry.TorusGeometry = function ( editor, object ) {
	...
	tubeRow.add( new UI.Text( editor.languageData.Tube ).setWidth( '90px' ) );
	tubeRow.add( tube );
	...
	tubularSegmentsRow.add( new UI.Text( editor.languageData.Tubularsegments ).setWidth( '90px' ) );
	...
	arcRow.add( new UI.Text( editor.languageData.Arc ).setWidth( '90px' ) );
	arcRow.add( arc );
