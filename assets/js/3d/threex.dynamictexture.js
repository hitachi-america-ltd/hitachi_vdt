 ...
 */
THREEx.DynamicTexture	= function(width, height,value){
		...
		if(value){
			...
			function createCircleTexture(color, size) {
				  ...
				  var result = [texture,matContext,matCanvas]
				  return result;
			}
			var premtex     =  createCircleTexture('#fd8b29', 256)
			this.canvas	    = premtex[2]
			this.context	= premtex[1]
			this.texture	= premtex[0]
 ...
 */
THREEx.DynamicTexture.prototype.clear = function(fillStyle,value){
	...
	if(value){
		...
		if( fillStyle !== undefined ){
			...
			this.context.arc(center, center, 356/2, 0, 2 * Math.PI, false);
		}
		else{
		...
		if( fillStyle !== undefined ){
			this.context.fillStyle	= fillStyle
			this.context.font	= "bolder 158px Verdana";
			this.context.fillRect(0,0,this.canvas.width, this.canvas.height)
		}else{
			this.context.font	= "bolder 158px Verdana";
			this.context.clearRect(0,0,this.canvas.width, this.canvas.height)
