...
Sidebar.Material = function ( editor ) {
	...
	materialSlotRow.add( new UI.Text(  editor.languageData.Slot ).setWidth( '90px' ) );
	...
	managerRow.add( new UI.Button(  editor.languageData.New ).onClick( function () {
	...
	managerRow.add( new UI.Button(  editor.languageData.Copy ).setMarginLeft( '4px' ).onClick( function () {
	...
	managerRow.add( new UI.Button(  editor.languageData.Paste ).setMarginLeft( '4px' ).onClick( function () {
	...
	materialClassRow.add( new UI.Text(  editor.languageData.Type ).setWidth( '90px' ) );
	...
	materialNameRow.add( new UI.Text( editor.languageData.Name ).setWidth( '90px' ) );
	...
	materialProgramRow.add( new UI.Text( editor.languageData.Program ).setWidth( '90px' ) );

	var materialProgramInfo = new UI.Button( editor.languageData.Info );
	...
	var materialProgramVertex = new UI.Button( editor.languageData.Vertex );
	...
	var materialProgramFragment = new UI.Button( editor.languageData.Fragment );
	...
	materialColorRow.add( new UI.Text( editor.languageData.Color ).setWidth( '90px' ) );
	...
	materialRoughnessRow.add( new UI.Text( editor.languageData.Roughness ).setWidth( '90px' ) );
	...
	materialMetalnessRow.add( new UI.Text( editor.languageData.Metalness ).setWidth( '90px' ) );
	...
	materialEmissiveRow.add( new UI.Text( editor.languageData.Emissive ).setWidth( '90px' ) );
	...
	materialSpecularRow.add( new UI.Text( editor.languageData.Specular ).setWidth( '90px' ) );
	...
	materialShininessRow.add( new UI.Text( editor.languageData.Shininess ).setWidth( '90px' ) );
	...
	materialClearCoatRow.add( new UI.Text( editor.languageData.ClearCoat ).setWidth( '90px' ) );
	...
	materialClearCoatRoughnessRow.add( new UI.Text( editor.languageData.ClearCoatRoughness ).setWidth( '90px' ) );
	...
	materialVertexColorsRow.add( new UI.Text(  editor.languageData.VertexColors ).setWidth( '90px' ) );
	...
	materialSkinningRow.add( new UI.Text(  editor.languageData.Skinning ).setWidth( '90px' ) );
	...
	materialMapRow.add( new UI.Text(  editor.languageData.Map ).setWidth( '90px' ) );
	...
	materialAlphaMapRow.add( new UI.Text(  editor.languageData.AlphaMap ).setWidth( '90px' ) );
	...
	materialBumpMapRow.add( new UI.Text(  editor.languageData.BumpMap ).setWidth( '90px' ) );
	...
	materialNormalMapRow.add( new UI.Text(  editor.languageData.NormalMap ).setWidth( '90px' ) );
	...
	materialDisplacementMapRow.add( new UI.Text(  editor.languageData.DisplaceMap ).setWidth( '90px' ) );
	...
	materialRoughnessMapRow.add( new UI.Text(  editor.languageData.RoughMap ).setWidth( '90px' ) );
	...
	materialMetalnessMapRow.add( new UI.Text(  editor.languageData.MetalMap ).setWidth( '90px' ) );
	...
	materialSpecularMapRow.add( new UI.Text(  editor.languageData.SpecularMap ).setWidth( '90px' ) );
	...
	materialEnvMapRow.add( new UI.Text(  editor.languageData.EnvMap ).setWidth( '90px' ) );
	...
	materialLightMapRow.add( new UI.Text(  editor.languageData.LightMap ).setWidth( '90px' ) );
	...
	materialAOMapRow.add( new UI.Text(  editor.languageData.AOMap ).setWidth( '90px' ) );
	...
	materialEmissiveMapRow.add( new UI.Text(  editor.languageData.EmissiveMap ).setWidth( '90px' ) );
	...
	materialSideRow.add( new UI.Text(  editor.languageData.Side ).setWidth( '90px' ) );
	...
	materialShadingRow.add( new UI.Text(  editor.languageData.FlatShaded ).setWidth( '90px' ) );
	...
	materialBlendingRow.add( new UI.Text(  editor.languageData.Blending ).setWidth( '90px' ) );
	...
	materialOpacityRow.add( new UI.Text(  editor.languageData.Opacity ).setWidth( '90px' ) );
	...
	materialTransparentRow.add( new UI.Text(  editor.languageData.Transparent ).setWidth( '90px' ) );
	...
	materialAlphaTestRow.add( new UI.Text(  editor.languageData.AlphaTest ).setWidth( '90px' ) );
	...
	materialWireframeRow.add( new UI.Text(  editor.languageData.Wireframe ).setWidth( '90px' ) );
