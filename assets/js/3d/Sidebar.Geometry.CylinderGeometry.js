...
Sidebar.Geometry.CylinderGeometry = function ( editor, object ) {
	...
	radiusTopRow.add( new UI.Text( editor.languageData.Radiustop ).setWidth( '90px' ) );
	...
	radiusBottomRow.add( new UI.Text( editor.languageData.Radiusbottom ).setWidth( '90px' ) );
	...
	heightRow.add( new UI.Text( editor.languageData.Height ).setWidth( '90px' ) );
	...
	radialSegmentsRow.add( new UI.Text( editor.languageData.Radialsegments ).setWidth( '90px' ) );
	...
	openEndedRow.add( new UI.Text( editor.languageData.Openended ).setWidth( '90px' ) );
