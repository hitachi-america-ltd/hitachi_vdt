...
Sidebar.Geometry = function ( editor ) {
	...
	*/
	...
	geometryTypeRow.add( new UI.Text( editor.languageData.Type ).setWidth( '90px' ) );
	...
	var geometryUUIDRenew = new UI.Button( editor.languageData.New ).setMarginLeft( '7px' ).onClick( function () {
	...
	geometryNameRow.add( new UI.Text( editor.languageData.Name ).setWidth( '90px' ) );
